...
init python:
    ...
    def _resolve_display_font():
        def _renpy_font_path(path):
            return path.replace("\\", "/")

        bundled_candidates = [
            "gui/fonts/avenir.OTF",
        ]
        ...
        for candidate in system_candidates:
            ...
            if os.path.exists(path):
                return _renpy_font_path(path)

        return "DejaVuSans.ttf"

    _display_font = _resolve_display_font()
...
define gui.accent_color = '#FFCA7E'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#00c9af'
...
define gui.text_font = _display_font

## The font used for character names.
define gui.name_text_font = _display_font

## The font used for out-of-game text.
define gui.interface_text_font = _display_font
...
define gui.main_menu_background = "images/background/menu_background.jpg"
define gui.game_menu_background = "images/background/menu_background.jpg"
